...
format: 
  revealjs:
    theme: simple
    footer: "CES Skills seminar / 8th December 2023 / JR Ferrer-Paris"
...
- Shiny Webapp [{{< fa link >}}](https://posit-connect-unsw.intersect.org.au/africa-tropical-alpine/) / [{{< fa brands github >}}](https://github.com/jrfep/T6.5-tropical-alpine-model-calibration)
- Quarto website: [{{< fa link >}}](https://neomapas.github.io)
...
This presentation was created using [RStudio](https://posit.co/products/open-source/rstudio/), [Quarto v.1.3.433](https://quarto.org/docs/presentations/) with [fontawesome extension](https://github.com/quarto-ext/fontawesome), and [reveal.js](https://revealjs.com/). 
