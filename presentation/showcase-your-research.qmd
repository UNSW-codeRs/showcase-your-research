...
- Fully developed blogdown project:
  - {{< fa link >}} <https://unsw-coders.netlify.app>
- Fully developed quarto projects:
  - {{< fa link >}} <https://red-list-ecosystem.github.io/T6.1-SA-01-VE-01-Cordillera-Merida/>
  - {{< fa link >}} <https://neomapas.github.io>
